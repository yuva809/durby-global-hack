...
export const VALUE_PROPS: ValueProp[] = [
  ...
  { title: "Compete Internationally", description: "Go up against builders from India, Germany and beyond.", icon: Trophy },
  ...
  { title: "Meet Other Builders", description: "Build a network of builders across two countries and beyond.", icon: Handshake },
  { title: "Gain Visibility", description: "Showcase your work to mentors, judges and partner organizations.", icon: Eye },
  { title: "University & Industry Exposure", description: "Planned visibility with German university and industry partners in attendance.", icon: GraduationCap },
